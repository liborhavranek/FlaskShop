...
class NotebookForm(FlaskForm):
    ...
    display_frequency = IntegerField(
        "Frekvence obnovování:", validators=[NumberRange(min=0)], default=0
    )
    display_nits = IntegerField(
        "Jas displeje:", validators=[NumberRange(min=0)], default=0
    )
    ...
    processor_cores = IntegerField(
        "Počet jader:", validators=[NumberRange(min=0)], default=0
    )

    operating_memory = IntegerField(
        "Operační paměť *:", validators=[InputRequired(), NumberRange(min=0)], default=0
    )

    graphics_card = SelectField(
        "Grafická karta:",
        validators=[Optional()],
        choices=[
    ...
    graphics_memory = IntegerField(
        "Velikost grafické paměti:", validators=[NumberRange(min=0)], default=0
    )

    operating_system = SelectField(
        "Operační systém *:",
        choices=[("Windows", "Windows"), ("macOS", "macOS")],
        validators=[Optional()],
    )
    ...
    ssd_capacity = IntegerField(
        "Velikost disku SSD:",
        validators=[InputRequired(), NumberRange(min=0)],
        default=0,
    )
    hdd_capacity = IntegerField(
        "Velikost disku HDD:",
        validators=[InputRequired(), NumberRange(min=0)],
        default=0,
    )
    ...
    battery_capacity = IntegerField(
        "Kapacita baterie:", validators=[NumberRange(min=0)], default=0
    )
    construction = SelectField(
        "Konstrukce:", choices=[("celokovovy", "celokovový"), ("plastovy", "plastový")]
    )
    ...
    usb_ports = IntegerField(
        "Počet USB portů:", validators=[NumberRange(min=0)], default=0
    )
    hdmi_ports = IntegerField(
        "Počet HDMI portů:", validators=[NumberRange(min=0)], default=0
    )
