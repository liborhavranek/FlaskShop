...
class MobileForm(FlaskForm):
    ...
    memory = IntegerField(
        "Velikost disku *:", validators=[InputRequired(), NumberRange(min=0)], default=0
    )
    ...
    front_camera = IntegerField(
        "Přední kamera:", validators=[NumberRange(min=0)], default=0
    )
    back_camera = IntegerField(
        "Zadní kamera:", validators=[NumberRange(min=0)], default=0
    )
    height = DecimalField(
