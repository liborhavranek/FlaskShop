...
class TestAddBrand(TestMixin, unittest.TestCase):
    ...
    def test_products_create_brand_return_correct_message_when_brand_created(self):
        ...
        response = self.client.post(
            "/products/create-brand", data=data, follow_redirects=True
        )
    ...
    def test_product_create_brand_cant_save_in_db_the_same_brand_again(self):
        ...
        self.assertIn(
            bytes("Tato značka je už zaregistrována v naší databázi.", "utf-8"),
            response.data,
        )
    ...
    def test_product_create_brand_cant_be_less_than_two_char(self):
        ...
        self.assertIn(
            bytes("Značka musí mít alespoň dva znaky.", "utf-8"), response.data
        )

    def test_check_brand_aviable(self):
        self.login_user()
        response = self.client.post(
            "products/check-brand", data={"brand_name": "Samsung"}
        )
    ...
    def test_check_brand_taken(self):
        ...
        self.client.post("/products/create-brand", data=data, follow_redirects=True)
        response = self.client.post(
            "products/check-brand", data={"brand_name": "Apple"}
        )
...
class TestEditBrand(TestMixin, unittest.TestCase):
    ...
    def create_brand(self):
        ...
        self.client.post(
            "/products/create-brand", data=self.data, follow_redirects=True
        )
    ...
    def test_check_brand_taken(self):
        ...
        self.create_brand()
        self.client.post(
            "/products/edit-brand/1", data=self.data, follow_redirects=True
        )
        response = self.client.post(
            "products/check-brand", data={"brand_name": "Apple"}
        )
    ...
    def test_products_edit_brand_return_correct_message_when_the_same_brand_try_add_in_db(
        self,
    ):
        self.login_user()
        self.create_brand()
    ...
    def test_products_edit_brand_return_correct_message_when_brand_is_edited(self):
        ...
        self.create_brand()
        response = self.client.post(
            "/products/edit-brand/1",
            data={"brand_name": "Samsung"},
    ...
    def test_product_edit_brand_cant_be_less_than_two_char(self):
        ...
        self.create_brand()
        response = self.client.post(
            "/products/edit-brand/1", data={"brand_name": "A"}, follow_redirects=True
        )
        self.assertIn(
            bytes("Značka musí mít alespoň dva znaky.", "utf-8"), response.data
        )
...
class TestAddCategory(TestMixin, unittest.TestCase):
    ...
    def test_products_create_category_return_correct_message_when_category_created(
        self,
    ):
        self.create_category()
        response = self.client.post(
            "/products/create-category", data=self.data, follow_redirects=True
        )
    ...
    def test_product_create_category_cant_save_in_db_the_same_category_again(self):
        ...
        self.assertIn(
            bytes("Tato kategorie je už zaregistrována v naší databázi.", "utf-8"),
            response.data,
        )
    ...
    def test_product_create_category_cant_be_less_than_two_char(self):
        ...
        response = self.client.post(
            "/products/create-category", data=data, follow_redirects=True
        )
        self.assertIn(
            bytes("Kategorie musí mít alespoň dva znaky.", "utf-8"), response.data
        )
...
class TestEditCategory(TestMixin, unittest.TestCase):
    ...
    def test_products_edit_category_have_category_edited_true_when_category_is_edited(
        self,
    ):
        self.login_user()
        self.create_category()
        self.client.post(
            "/products/edit-category/1",
            data={"category_name": "Nnotebooky"},
            follow_redirects=True,
        )
    ...
    def test_check_category_aviable(self):
        self.login_user()
        response = self.client.post(
            "products/check-category", data={"category_name": "Notebooky"}
        )
        self.assertEqual(response.data, b"available")
    ...
    def test_check_category_taken(self):
        ...
        self.create_category()
        self.client.post(
            "/products/edit-category/1", data=self.data, follow_redirects=True
        )
        response = self.client.post(
            "products/check-category", data={"category_name": "Mobilní telefony"}
        )
        self.assertEqual(response.data, b"taken")
...
class TestAddProduct(TestMixin, unittest.TestCase):
    ...
    def test_create_product_return_correct_message_when_short_name(self):
        ...
        response = self.client.post(
            "/products/create-mobile-product", data=data, follow_redirects=True
        )
        self.assertIn(
    ...
    def test_product_already_registered(self):
        ...
        self.assertIn(
            b"Tento produkt je u\xc5\xbe zaregistrov\xc3\xa1n v na\xc5\xa1\xc3\xad datab\xc3\xa1zi.",
            response.data,
        )
    ...
    def test_check_product_taken(self):
        ...
        self.client.post(
            "/products/create-mobile-product",
            data=self.product_data,
            follow_redirects=True,
        )
        response = self.client.post(
            "products/check-product",
            data={"product_name": "iPhone 13 Pro Max 1T černá"},
        )
        self.assertEqual(response.data, b"taken")
    ...
    def test_check_product_aviable(self):
        ...
        self.client.post(
            "/products/create-product", data=self.data, follow_redirects=True
        )
        response = self.client.post(
            "products/check-product", data={"product_name": "Iphon"}
        )
        self.assertEqual(response.data, b"available")
...
class TestEditProduct(TestMixin, unittest.TestCase):
    ...
    def test_edit_product_edit_product_name(self):
        ...
        response = self.client.post(
            "/products/edit-mobile-product/1", data=edit_data, follow_redirects=True
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_edit_product_flash_message_when_product_is_edited(self):
        self.create_product()
        edit_data = {
            "product_name": "iPhone 13 Pro Max 1T",
            "price": 47390,
            "discount": 0,
            "stock": 20,
            "display_size": 6.7,
    ...
    def test_edit_product_cant_be_changed_to_name_of_another_product(self):
        ...
        self.client.post(
            "/products/create-mobile-product", data=self.data, follow_redirects=True
        )
        edit_data = {
            "product_name": "iPhone 13 Pro Max 1T černá2",
            "price": 47390,
    ...
    def test_edit_product_flash_message_when_try_add_the_same_name(self):
        ...
        # check that the product name has been updated in the database
        self.assertIn(
            bytes("Produkt s tímto názvem již existuje.", "utf-8"), response.data
        )
...
class TestAddNotebook(TestMixin, unittest.TestCase):
    ...
    def create_product(self):
        ...
        product_data = {
            ...
            "operating_memory": 8,
            "description": "Macbook Pro je výkonný a univerzální notebook navržený"
        ...
        self.client.post(
            "/products/create-notebook-product",
            data=product_data,
            follow_redirects=True,
        )
    ...
    def test_create_product_return_correct_message_when_short_name(self):
        ...
        data = {
            ...
            "operating_system": "macOS",
            "operating_memory": 8,
            "description": "Macbook Pro je výkonný a univerzální notebook "
            "navržený pro profesionály a náročné uživatele. "
            "S jeho špičkovým výkonem a ohromujícím vizuálním zážitkem si můžete být jistí, že zvládnete "
            "jakýkoli úkol a projdete se plynule nejnovějšími aplikacemi a programy. Díky Retina displeji "
            "si užijete nádherné podrobnosti a živé barvy ve vysokém rozlišení. Přesné a ostré obrazy vás přenáší "
            "do světa, kde se každý detail zobrazuje s ohromující jasností. Procesor Intel Core i7 a 4 jádra "
        ...
        response = self.client.post(
            "/products/create-notebook-product", data=data, follow_redirects=True
        )
        self.assertIn(
            bytes("Produkt musí mít alespoň dva znaky.", "utf-8"), response.data
        )
