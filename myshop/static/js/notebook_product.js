    ...
    // Function to show/hide HDD capacity field based on checkbox state
    function toggleHDDCapacityField() {
        if ($('.add-notebook-hdd-disk-input').is(':checked')) {
    ...
    // Function to show/hide SSD capacity field based on checkbox state
    function toggleSSDCapacityField() {
        if ($('.add-notebook-ssd-disk-input').is(':checked')) {
    ...
    $('.add-notebook-hdd-disk-input').change(function() {
        toggleHDDCapacityField();
    });

    // Listen for changes in the SSD checkbox state
    $('.add-notebook-ssd-disk-input').change(function() {
        toggleSSDCapacityField();
    });
