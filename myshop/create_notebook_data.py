...
products = [
    ...
    },
    {
        ...
        "operating_system": "macOS",
        "operating_memory": 16,
        "description": "Macbook Air s čipem M1 je výkonný a přenosný notebook navržený pro každodenní použití a"
        " mobilitu. "
    ...
    },
    {
        ...
        "operating_memory": 16,
        "description": "Notebook MSI Katana 15 B12VFK-1016XCZ je výkonný a mobilní notebook navržený pro herní"
        " a pracovní "
    ...
    },
    {
        ...
        "operating_system": "Windows 10 Home",
        "operating_memory": 16,
        "description": "MSI Crosshair 15 B12UGZ-072CZ je výkonný herní notebook s 15.6-palcovým displejem a vysokým"
        " rozlišením 1920 x 1080. Je vybaven procesorem Intel Core i7 a 16 GB operační paměti, které"
        " poskytují dostatečný výkon pro hraní náročných her a provádění multitaskingu. Notebook "
        "disponuje 512 GB SSD pro rychlé načítání systému a aplikací a také pro dostatečný "
        "úložný prostor pro vaše soubory a hry. Grafická karta NVIDIA GeForce RTX 3060 "
        "s 6 GB paměti zajišťuje plynulé a detailní zobrazení grafiky ve hrách. MSI Crosshair"
        " 15 B12UGZ-072CZ je vyroben z kvalitních materiálů, které zajišťují odolnost "
        "a dlouhodobou spolehlivost. Jeho stylový design a RGB podsvícení klávesnice "
        "přispívají k atraktivnímu vzhledu. Notebook je vybaven různými porty, včetně USB, "
        "HDMI a audio konektorů, pro snadné připojení periferních zařízení. "
        "S MSI Crosshair 15 B12UGZ-072CZ získáte výkonný herní notebook,"
        " který vám umožní vychutnat si hraní her a provádění náročných úkolů.",
